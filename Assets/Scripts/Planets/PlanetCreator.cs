...
public class PlanetCreator : MonoBehaviour
{
    ...
    void GeneratePrefab()
    {
        ...
        {
            newPrefab = (GameObject)Instantiate(ArrayPrefabs[rand], new Vector2(newPrefab.transform.position.x + 5f, Random.Range(-5, 5)/* + transform.position.y*/), Quaternion.identity);
